...
static LRESULT CALLBACK SizeTipWndProc(HWND hWnd, UINT nMsg, WPARAM wParam,
		LPARAM lParam) {
...
void UpdateSizeTip(HWND src, int cx, int cy) {
	...
	if (!tip_wnd) {
		...
		tip_wnd = CreateWindowEx(WS_EX_TOOLWINDOW | WS_EX_TOPMOST,
				MAKEINTRESOURCE(tip_class), str, WS_POPUP, ix, iy, sz.cx, sz.cy,
